...
namespace Unity.FPS.UI
{
    ...
    {
        //[Header("The text that will be displayed")] [TextArea]
        //public string message;
        //
        //[Header("Prefab for the message")] public GameObject messagePrefab;
        //
        //[Header("Delay before displaying the message")]
