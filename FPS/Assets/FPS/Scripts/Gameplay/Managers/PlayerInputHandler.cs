...
namespace Unity.FPS.Gameplay
{
    ...
    {
        [Header("Sensitivity multiplier for moving the camera around")]
        public float LookSensitivity = 1f;

        [Header("Additional sensitivity multiplier for WebGL")]
        public float WebglLookSensitivityMultiplier = 0.25f;

        [Header("Limit to consider an input when using a trigger on a controller")]
        public float TriggerAxisThreshold = 0.4f;

        [Header("Used to flip the vertical input axis")]
        public bool InvertYAxis = false;

        [Header("Used to flip the horizontal input axis")]
